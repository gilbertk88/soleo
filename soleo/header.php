...
<head>
    ...
    <style>
	  ...
	  .s_intro_container{
		  background-image: url( "<?php echo get_template_directory_uri() . '/assets/img/bd_img.png';?> " ) ;
		  color:#2f3037;
	  }
...
<div id="page" class="site">
	...
	<header id="masthead" class="d-flex justify-content-center py-3 row" >
		<div class="site-branding col-12 row">
			...
			$soleo_description = get_bloginfo( 'description', 'display' );
			if ( $soleo_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php //echo $soleo_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		...
		<nav id="site-navigation" class="main-navigation">
			<div class='row g-4 py-9 row-cols-3'>
				<div class="col-4"></div>
				<div class="col-4">
					<?php
					wp_nav_menu(
